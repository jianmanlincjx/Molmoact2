...
SEED="${SEED:-1000}"
export RUN_TYPE=baseline_35k
export JOB_NAME="${JOB_NAME:-molmoact2-libero-baseline-35k}"
...
export OUTPUT_DIR="${OUTPUT_DIR:-${EXPERIMENT_ROOT}/01_baseline_35k}"
export RESUME_MODE="${RESUME_MODE:-auto}"
export CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-0,1,2,3,4,5,6}"
export STEPS="${STEPS:-35000}"
